...
<?php
    ...
    $sql5 = "SELECT ID_HISTORY, TANGGAL, JUMLAH_HISTORY, PENGELUARAN_ATAU_PEMASUKAN FROM history_view WHERE TANGGAL BETWEEN '$date' AND  '$date' AND PENGELUARAN_ATAU_PEMASUKAN = 'Pengeluaran' ORDER BY TANGGAL DESC, ID_HISTORY DESC";
    ...
    $sql6 = "SELECT ID_HISTORY, TANGGAL, JUMLAH_HISTORY, PENGELUARAN_ATAU_PEMASUKAN FROM history_view WHERE TANGGAL BETWEEN '$date' AND  '$date' AND PENGELUARAN_ATAU_PEMASUKAN = 'Pemasukan' ORDER BY TANGGAL DESC, ID_HISTORY DESC";
